...
(
	idfacturacion integer not null identity(1,1)  primary key,
...
insert into facturacion (idcliente,monto_facturacion) values (22100,55.2);
...
insert into facturacion (idcliente,monto_facturacion) values (20831,124.6);
...
insert into facturacion (idcliente,monto_facturacion) values (2158,185.1);
...
insert into facturacion (idcliente,monto_facturacion) values (47652,16.4);
...
insert into facturacion (idcliente,monto_facturacion) values (47689,63.9);
